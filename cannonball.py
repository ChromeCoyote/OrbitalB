...
class Cannonball(cosmos.Celestial):
    ...
    def draw_explosion(self):
        """ Draw and check for collision with explosion on impacted homeworld """
        kaboom_color = (random.randint(0, 255), random.randint(0, 255), random.randint(0, 255))
        
        pygame.draw.circle(self.sts.screen, kaboom_color, (self.screen_x, \
            self.screen_y), self.explode_screen_radius)
